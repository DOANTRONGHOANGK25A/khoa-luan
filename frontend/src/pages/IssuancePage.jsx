...
import { Card, Tabs, Table, Button, Tag, Typography, Divider, Space, Modal, Upload, message, Tooltip, Empty, Input } from "antd";
import {
    SendOutlined,
    CheckCircleOutlined,
    CloseCircleOutlined,
...
export function IssuancePage() {
    ...
    const [walletCreated, setWalletCreated] = useState(() => localStorage.getItem("walletCreated") === "true");
